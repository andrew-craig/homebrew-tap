cask "lensbar" do
  ...
  on_arm do
    url "https://github.com/andrew-craig/lensbar/releases/download/#{version}/LensBar.dmg"
    sha256 "38c3e667c5c8956e24ecafcbb551acb03bbb9f1d5f1fc9b5d3b4cfacb1bd43fa"
  end

  on_intel do
    url "https://github.com/andrew-craig/lensbar/releases/download/#{version}/LensBar-universal.dmg"
